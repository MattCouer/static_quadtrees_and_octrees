...
public:
    ...
    int64_t floating_to_integral_z(real_t z);
    ...
    Vector3 get_octant_center(Ref<ZLocationalCode> octant);
    real_t get_octant_span(int64_t depth);
    // bool octant_slab_test(Ref<ZLocationalCode> octant, Vector3 origin, Vector3 direction);
	Ref<ZLocationalCode> get_octant_parent(Ref<ZLocationalCode> octant);
    TypedArray<ZLocationalCode> get_octant_children(Ref<ZLocationalCode> octant);
